...
<!DOCTYPE html>
  ...
  <head>
    ...
    <title> Registe - Hotal  Management</title>
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="card mb-3">
            <div class="card-header bg-primary text-white d-flex justify-content-between">
              <h4>แบบฟอร์มลงทะเบียนสินค้าใหม่</h4>
            ...
            <form action="{{ route('inventory.store')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="itemname" id="firstname" class="form-control">
                  @error('name')
                ...
                <div class="mb-3">
                  ...
                  <input type="number" name="Quantity" class="form-control" id="recipient-name">
                  @error('Quantity')
                    <div class="alert alert-danger">{{ $message}}</div>
                  @enderror
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="number" name="Unitprice" class="form-control" id="recipient-name">
                  @error('Unitprice')
                    <div class="alert alert-danger">{{ $message}}</div>
                  @enderror
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="number" name="Totalprice" class="form-control" id="recipient-name">
                  @error('Totalprice')
                    <div class="alert alert-danger">{{ $message}}</div>
                  @enderror
                </div>
